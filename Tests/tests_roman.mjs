...
}, "Roman numeral converter is defined");
...
tester.isEqual(romanNumeralConverter(50), "X", "Converting 50 to Roman");
...
tester.isEqual(romanNumeralConverter(647), "DCXLVII", "Converting 647 to Roman");
